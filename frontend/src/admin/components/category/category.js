...
const Category = () =>{
 ...
 const getdata=async()=>{
    setLoading(true);
    var res=await allcategory({first,rows,globalFilter});
  ...
  const save=async(event)=>{
     event.preventDefault();
      var res=await savecategory({...formdata,...{Category_img:selectedFile}});
      ...
      else if(res.error=="Image not found"){
 ...
 const update=async(event)=>{
  event.preventDefault();
  var res=await updatecategory({...formdata,...{Category_img:selectedFile==null?formdata.Category_img:selectedFile}});
  if(res.message=='success'){
...
const handleClearFilter=(event)=>{
  ...
  <div className="Category" data-testid="Category">
    ...
    <ToastContainer/>
    <ConfirmDialog />
    <Categorylist dt={dt} tabebodydata={tabebodydata} 
