                ...
                <form onSubmit={Updatewebsetting}>
                    ...
                    <div className="mb-3">
                        ...
                        <div className="uploadlogo">
                          <img src={`http://localhost/rbk_backend/storage/app/public/${websetting.logo}`} alt=""  height="50" className="border border-primary p-1 rounded"/>
                        </div>
                    </div>
                    <div className="mb-3">
                        ...
                        <span>16px x 16px or 32px x 32px</span> and  Accepted formats: only png and ico
                         ...
                         <div className="uploadlogo">
                          <img src={`http://localhost/rbk_backend/storage/app/public/${websetting.favicon}`} alt=""  height="50" className="border border-primary p-1 rounded"/>
                        </div>
                    </div>
                    <div className="mb-3">
